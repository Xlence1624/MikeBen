...
<div className='flex flex-col justify-center items-center mt-10'>
 <textarea name="message" onChange={handleChange} id=" "  placeholder='Write your message here.' className='border-b-1 border-purple-900/50 md:w-1/2  w-full  text-purple-950 outline-0  my-10 text-center' ></textarea>
