...
<div>
  <p className='text-center text-secondary text-6xl font-[700]'>Send me a message!</p>
  <p className='text-purple-950 text-2xl text-center mt-5'>Got a question or proposal, or just want <br />
